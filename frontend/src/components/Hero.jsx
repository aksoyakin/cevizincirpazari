            ...
            <div className="w-full sm:w-1/2 flex items-center justify-center py-10 sm:py-0">
                <div className={"text-[#414141]"}>
                    <div className={"flex items-center gap-2"}>
                        ...
                        <p className={"font-medium text-sm md:text-base"}>Taze, Sağlıklı, Lezzetli!</p>
                    </div>
                    <h1 className={"text-3xl sm:py-3 lg:text-5xl leading-relaxed text-orange-400"}>Ceviz İncir Pazarı</h1>
                    <div className={"flex items-center gap-2"}>
