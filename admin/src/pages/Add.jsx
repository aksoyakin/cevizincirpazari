...
const Add = ({token}) => {
   ...
   // const [subCategory, setSubCategory] = useState("Ceviz");
    const [bestseller, setBestseller] = useState(false);
    const [sizes, setSizes] = useState(["1KG"]);
...
{/*                <div>
            ...
            <div>
                ...
                <div className={"flex gap-3"}>
                    <div
                        onClick={() => setSizes(prev => prev.includes("1KG") ? prev.filter(item => item !== "1KG") : [...prev, "1KG"])}>
